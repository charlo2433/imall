...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    ImageView headPhonesHandFree, Laptops, watches, mobilePhones, tv, beauty, baby, game;

    Button btnlogout, btncheckOrder, maintain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btncheckOrder = findViewById(R.id.btn_check_new_order);
        maintain = findViewById(R.id.btn_maintain_products);
